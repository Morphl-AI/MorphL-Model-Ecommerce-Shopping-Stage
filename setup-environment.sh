...
chmod 660 /opt/secrets/ga_epna/gcloud_service_account.json
chgrp airflow /opt/secrets/ga_epna /opt/secrets/ga_epna/gcloud_service_account.json /opt/secrets/ga_epna/viewid.txt